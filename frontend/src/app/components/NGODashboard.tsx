    ...
    <div className="space-y-6">
      ...
      <div className="bg-card rounded-2xl border border-border shadow-sm overflow-hidden hover:shadow-lg transition-all duration-300">
        ...
        <div className="flex items-center gap-3 mb-3">
          ...
          <div>
            <h3 className="m-0 text-base font-semibold">ISRO Satellite Audit</h3>
            <p className="text-xs text-muted-foreground mt-0.5">Step 2 of workflow — NDVI verification</p>
          </div>
        </div>
